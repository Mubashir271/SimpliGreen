              ...
              <View key={task.id}>
                ...
                {taskMedia.length > 0 && (
                  <View style={styles.mediaList}>
                    {taskMedia.map(m => (
                      <View key={m.id} style={[styles.mediaBadge, m.file_type === 'certificate' ? styles.mediaCert : styles.mediaImg]}>
                        <Text style={styles.mediaIcon}>{m.file_type === 'certificate' ? '📄' : '🖼️'}</Text>
                        <Text style={styles.mediaName} numberOfLines={1}>{m.file_name}</Text>
                      </View>
                    ))}
                  </View>
                )}
